    ...
    <div class="container">
      ...
      <form class="form-inline" method="POST">
        ...
        <form class="form-inline" method="POST">
          <div class="form-group mx-sm-3 mb-2">
            <label for="inputPassword2" class="sr-only">Search</label>
            <select type="text" class="form-control" name="search_value" placeholder="Search">
              
              <option value="DE(202)">DE(202)</option>
            </select>
          </div>
          <button type="submit" name="search" class="btn btn-primary mb-2">Search</button>
        </form>
      <table id="t_table" class="table" >
                        ...
                        <tbody>
                            <?php
                                    ...
                                    JOIN student_info on enrolled_course.student_id = student_info.id Where student_info.name LIKE '$myVal' OR course.code LIKE '$myVal' 
                                    ";
                                    $i = 0;
